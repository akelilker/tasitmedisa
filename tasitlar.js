...
<head>
  ...
  <style>
    ...
    .kaporta-print-row { position: relative; display: flex; min-height: 110px; }
    ...
    .kaporta-print-fallback {
        ...
        width: 150px;
        height: 240px;
        margin-top: -45px; /* SVG'nin içindeki inatçı ölü boşluğu tamamen kestik */
