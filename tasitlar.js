...
(function() {
  ...
  var EVENT_MENU_EVENT_ICONS = {
    ...
    sigorta: '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><text x="12" y="15.4" style="fill:currentColor;stroke:none;font-family:Arial,sans-serif;font-size:8px;font-weight:800;text-anchor:middle">S</text></svg>',
    kasko: '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><text x="12" y="15.4" style="fill:currentColor;stroke:none;font-family:Arial,sans-serif;font-size:8px;font-weight:800;text-anchor:middle">K</text></svg>',
