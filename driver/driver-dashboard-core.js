...
setTimeout(function() {
runtime.loadFeature('password').then(function() {
if (typeof window.openDriverPasswordSuggestion === 'function') window.openDriverPasswordSuggestion();
}).catch(function(err){ console.warn('[Medisa] password feature:', err); });
}, 0);
}
