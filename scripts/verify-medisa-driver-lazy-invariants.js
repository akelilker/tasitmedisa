...
test('Driver asset version matrisi dar bump kullanır', () => {
  assert.match(files.bootstrap, /bootstrap:\s*'20260811\.1'/);
  ...
  assert.match(files.bootstrap, /featureCss:\s*'20260811\.1'/);
  assert.match(files.loginHtml, /driver-script\.js\?v=20260811\.1/);
  assert.match(files.dashboardHtml, /driver-script\.js\?v=20260811\.1/);
  assert.match(files.loginHtml, /driver-shell\.css\?v=20260731\.3/);
  assert.match(files.dashboardHtml, /driver-shell\.css\?v=20260731\.3/);
});
