...
test('asset pin chain bumped for changed runtime modules', function() {
  ...
  assert.match(coreSrc, /tasitlar:\s*'20260923\.3'/);
  ...
  assert.match(read('index.html'), /script-core\.js\?v=20260923\.3/);
  assert.match(read('sw.js'), /CACHE_VERSION = 'medisa-v2\.335'/);
  assert.match(read('sw.js'), /'\/script-core\.js\?v=20260923\.3'/);
});
