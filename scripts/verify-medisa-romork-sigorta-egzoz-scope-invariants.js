...
test('asset pin chain bumped for changed runtime modules', function() {
  ...
  assert.match(read('index.html'), /script-core\.js\?v=20260916\.4/);
  assert.match(read('sw.js'), /CACHE_VERSION = 'medisa-v2\.328'/);
  assert.match(read('sw.js'), /'\/script-core\.js\?v=20260916\.4'/);
});
