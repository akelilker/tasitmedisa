...
test('pin/SW chain', function() {
  assert.match(tasitlar, /MEDISA_TASITLAR_MODULE_VERSION = '20260926\.4'/);
  assert.match(scriptCore, /tasitlar:\s*'20260926\.4'/);
  assert.match(sw, /CACHE_VERSION = 'medisa-v2\.346'/);
