...
if (implementationPresent) {
  ...
  test('version ve SW cache beklenen değerde', function() {
    ...
    assert.match(index, /data-manager\.js\?v=20260729\.1/);
    assert.match(index, /script-core\.js\?v=20260729\.1/);
    assert.match(core, /ayarlarJs: '20260729\.1'/);
    assert.match(index, /style-core\.css\?v=20260724\.1/);
    assert.match(sw, /medisa-v2\.258/);
  });
