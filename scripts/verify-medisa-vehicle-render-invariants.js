...
console.log(JSON.stringify({ ok: true, checks: ['revisions', 'lookup-cache', 'metrics', 'list-brand-fit-removed', 'list-user-fit-retained', 'compact-column-balance', 'skip'] }, null, 2));
